...
#### Correccion de bugs
fix 1.1
- no se envian correos. nodemailer se bloqueó por ser considerado spam al enviar correos mediante STMP. cambie todo el codigo referido a nodemailer a una nueva opcion llamada resend. solucionado.
fix 1.0
